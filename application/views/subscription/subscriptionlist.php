			...
			<div class="main-container">
				...
				<div class="top-bar clearfix">
					<div class="page-title">
						<h4><div class="fs1" aria-hidden="true" data-icon="&#xe007;"></div>Subscription Management</h4>
					</div>
					<ul class="right-stats hidden-xs" id="mini-nav-right">
						...
						<li>
						  <?php echo form_open_multipart("Subscription/");?>
						...
						<li>
						<?php echo anchor("Subscription/Add/","<i class='fa fa-plus-circle' aria-hidden='true'> Subscription</i>",'class="btn btn-info sb-open-right  sb-close" style="margin-bottom: 44px;"');?>
